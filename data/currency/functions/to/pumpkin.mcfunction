...
execute if score @s temp matches 1.. unless score weight_pumpkin global >= 100 internal run scoreboard players operation weight_pumpkin global += 1 internal
# Divide by 100, multiply by 101
execute if score @s temp matches 1.. if score weight_pumpkin global >= 100 internal run scoreboard players set @s temp 2
execute if score @s temp matches 1.. if score @s temp matches 2.. run scoreboard players operation weight_pumpkin global *= 101 internal
execute if score @s temp matches 1.. if score @s temp matches 2.. run scoreboard players operation weight_pumpkin global /= 100 internal
