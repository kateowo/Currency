...
execute if score @s temp matches 1.. run give @s wheat 1

# Success
execute if score @s temp matches 1.. run tellraw @s [{"text":"Bought ","color":"green"},{"text":"Wheat","color":"yellow","bold":true},{"text":" for ","color":"green"},{"text":"$","color":"gold","bold":true,"italic":false},{"score":{"name":"weight_wheat","objective":"global"},"color":"yellow","bold":true}]
