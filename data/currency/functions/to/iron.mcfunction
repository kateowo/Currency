...
# Error
execute if score @s temp matches 0 run tellraw @s [{"text":"You do not have $","color":"red"},{"score":{"name":"weight_iron","objective":"global"}},{"text":" available, operation denied."}]
