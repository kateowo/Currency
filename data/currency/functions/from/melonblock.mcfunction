...
execute if score @s temp matches 1.. run scoreboard players operation weight_melonblock global *= 99 internal
execute if score @s temp matches 1.. run scoreboard players operation weight_melonblock global /= 100 internal
