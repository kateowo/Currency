...
# Selling
execute if score @s temp matches 1.. run scoreboard players add sold_lapis temp 1
# Divide by 100, multiply by 99
execute if score sold_lapis temp matches 3.. run scoreboard players operation weight_lapis global *= 99 internal
execute if score sold_lapis temp matches 3.. run scoreboard players operation weight_lapis global /= 100 internal
execute if score sold_lapis temp matches 3.. unless score weight_lapis global matches 1.. run scoreboard players set weight_lapis global 1 
execute if score sold_lapis temp matches 3.. run scoreboard players reset sold_lapis temp
